...
const GlobalHeader: React.FC = () => {
  ...
  return (
    <header className="bg-zinc-800 border-b border-zinc-700 sticky top-0 z-10 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              onClick={() => router.push("/")}
              className="p-2 rounded-md bg-zinc-700 hover:bg-zinc-600 text-zinc-300 hover:text-zinc-100 cursor-pointer"
              title="Home"
            >
              <Home size={20} />
            </Button>
