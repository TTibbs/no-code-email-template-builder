  ...
  return (
    <main className="bg-zinc-800 min-h-screen font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div>
                ...
                <p className="text-zinc-300 mb-6">
                  ...
                  of your email. Add your content, change colors, adjust
                  layouts, and incorporate your brand elements with simple
            ...
            >
              <div>
                ...
                <p className="text-zinc-300 mb-6">
                  Preview how your email will appear across different devices
                  and email clients. Send test emails to yourself or team
                  members to ensure everything looks perfect before launching
                  your campaign.
                </p>
                <div className="flex items-center text-emerald-400">
                  <ArrowRight className="mr-2" size={16} />
      ...
      <motion.section
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="px-4 md:px-16 py-16 bg-zinc-900"
        id="features"
      >
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">
          Features
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-zinc-800 p-6 rounded-xl border border-zinc-700 hover:border-zinc-500 transition-all duration-300 flex flex-col"
          >
            ...
            <div className="text-center">
              <p className="text-zinc-400">
                Easily create and modify email templates with our intuitive drag
                and drop interface. No coding knowledge required.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-zinc-400">
                Upload and incorporate your own images directly into your email
